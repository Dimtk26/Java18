...
public class Vector3D {
    ...
    public static void main(String args[])
    {
        ...
        Vector3D vec2 = new Vector3D(2, 1, 3);

        // Vector3D vec3 = new Vector3D();
        /* if(vec1 == vec3) {System.out.println("1)Вектора равны");}
        else {System.out.println("1)Вектора не равны");}*/

        if(vec1 == vec1) {System.out.println("1)Вектор равен себе");}//3-3
        else {System.out.println("1)Вектор не равен себе");}

        if(vec1.equals(vec2)) {System.out.println("2)Вектора равны");}
        else {System.out.println("2)Вектора не равны");}
